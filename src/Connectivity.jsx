...
function Connectivity() {
  ...
  return (
    <>
      <section
        id="connectivity"
        className="z-20 w-full bg-[url('/img/bg-mobile.png')] bg-cover bg-top bg-no-repeat"
      >
        {/* Horizontal Line */}
        ...
        <div className="relative z-0 mx-auto w-full max-w-[470px] bg-[url('/img/curve-mobile.png')] bg-cover bg-top bg-no-repeat lg:max-w-[700px] xl:max-w-[740px] ">
