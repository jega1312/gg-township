function ProductCard(props) {
  return (
    <div className="3xl:max-w-5xl mx-auto flex min-h-[260px] w-full max-w-xl flex-col justify-around rounded-3xl border border-[#e5e7eb] shadow-lg sm:min-h-[620px] md:min-h-[460px] md:max-w-lg lg:max-w-md 2xl:max-w-xl">
      ...
      <div className="3xl:pt-[18px] flex flex-col justify-center border-b border-[#e5e7eb] py-5 pt-[30px]">
      ...
      <div className="gotham-book table h-20 w-full border-b border-[#e5e7eb] p-2.5 xl:px-5 3xl:py-0 text-center text-[13px] text-[#555555] xl:h-[90px] 3xl:h-20 xl:text-[14px]">
      ...
      <div className="flex items-center border-b border-[#e5e7eb] py-4 xl:py-4.5 3xl:py-0">
        <div className="gotham-book 3xl:pl-5 w-1/2 border-r border-[#42b58b] py-2.5 pl-[15px] xl:pl-5 text-[13px] text-[#555555] xl:text-[14px]">
          Price From <br />
          <span className="hk-nova text-[18px] text-black">{props.price}</span>
        </div>

        <div className="gotham-book 3xl:pl-5 w-1/2 py-2.5 pl-[15px] xl:pl-5 text-[13px] text-[#555555] xl:text-[14px]">
          Monthly Payment <br />
