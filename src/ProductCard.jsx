function ProductCard(props) {
  return (
    <div className="3xl:max-w-5xl mx-auto flex min-h-[260px] w-full max-w-xl flex-col justify-around rounded-3xl border border-[#e5e7eb] shadow-lg sm:min-h-[620px] md:min-h-[460px] md:max-w-lg lg:max-w-md 2xl:max-w-lg">
      <img
        src={props.image}
        alt="Product Image"
      ...
      <div className="gotham-book table h-[80px] w-full border-b border-[#e5e7eb] p-[10px] text-center text-[13px] text-[#555555] xl:h-[90px] xl:text-[14px]">
        <div className="table-cell align-middle">{props.description}</div>
      </div>

      <div className="flex items-center border-b border-[#e5e7eb] py-1">
        <div className="gotham-book 3xl:pl-[20px] w-1/2 border-r border-[#42b58b] py-[10px] pl-[10px] text-[13px] text-[#555555] xl:text-[14px]">
          Price From <br />
          <span className="hk-nova text-[18px] text-black">{props.price}</span>
        </div>

        <div className="gotham-book 3xl:pl-[20px] w-1/2 py-[10px] pl-[10px] text-[13px] text-[#555555] xl:text-[14px]">
          Monthly Payment <br />
