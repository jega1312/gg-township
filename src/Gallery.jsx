  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="nelphim mx-auto w-full text-center text-[35px] leading-[1em] text-white md:text-[40px] xl:text-[45px] xl:text-[50px]">
            Discover <br /> <span className="text-[65px]">G</span>amuda Gardens
          </div>
          <div className="hk-nova text-center text-[14px] text-white md:text-[16px] xl:text-[18px] xl:text-[20px]">
