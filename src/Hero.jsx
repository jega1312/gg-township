...
function Hero() {
  ...
  return (
    <>
      <section id='hero' className="h-screen bg-[url('../assets/images/hero-mobile.png')] bg-cover bg-center bg-no-repeat sm:rounded-b-2xl sm:bg-[url('../assets/images/hero-desktop.png')]">
        {/* Hero Text */}
